        ...
        <div class="cotainer">
            ...
            <div class="row mt-5 text-center mb-5">
                <div class="col-lg-4 offset-lg-4">
                    <h3><img src="img/tkj.png" width="50" alt="" data-aos="flip-left" data-aos-duration="2000">
                        Please {{ $title }}</h3>
                </div>
                        ...
                        <form action="/registrasi" method="post">
                            ...
                            <div class="mb-1">
                                <input type="text" id="alamat" name="alamat" placeholder="Alamat..."
                                    value="{{ old('alamat') }}" class="form-control @error('alamat') is-invalid @enderror">
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-1">
                                <input type="number" id="no_handphone" name="no_handphone" placeholder="No. Handphone..."
                            ...
                            <div>
                                <p><small>already have an account? <a href="login"
