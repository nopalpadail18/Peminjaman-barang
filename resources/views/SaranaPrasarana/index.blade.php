...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="col-lg-12">
           @if($barangs->count() > 0)
           <p class="text-success">Pencarian Barang <strong style="font-style: italic">"{{ request('search') }}"</strong> ditemukan!</p>
           @else 
           <p class="text-danger">Pencarian Barang <strong style="font-style: italic">"{{ request('search') }}"</strong> tidak ditemukan!</p>
           @endif
        </div>
        </div>
        @endif
