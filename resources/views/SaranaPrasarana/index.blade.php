        ...
        <div class="container">
                ...
                <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-8 offset-sm-2 col-12">
                    ...
                    <form action="" method="get">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Cari Category Dan Barang" name="search"
            ...
            @if (request('search'))
                <div class="row mb-3 text-center mb-3">
                    <div class="col-lg-12">
                        @if ($barangs->count() > 0)
                            <p class="text-success">Pencarian Barang <strong
                                    style="font-style: italic">"{{ request('search') }}"</strong> ditemukan!</p>
                        @else
                            <p class="text-danger">Pencarian Barang <strong
